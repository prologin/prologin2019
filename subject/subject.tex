...
\def\ptitle{\textsc{Exploitation minière P.R.O.L.O.G.I.N.}} %% Subject's main title
\def\psubtitle{Mine standard de granite standard} %% Subject's sub title

\def\plogo{prologin2019.pdf} %% Logo FIXME
\def\psubjectpicture{logo_subject.pdf} %% Picture to be displayed FIXME
