...
\subsection{Les nains (standards)}
  ...
  bières dans les mains.\footnote{Bref, des nains quoi.}}
...
\subsection{C'est qui, lui?}
  ...
  certains nains auraient été blessés dans les mines, plus précisément certains
  auraient présenté des signes de contusion de pioches. Soyez
...
\subsection{Le granit (standard)}
  ...
  valeur de très exactement 0 pièce d'or\footnote{Avec 20\% de taxes, on peut
  mieux faire en terme de rentabilité.}, et requiert un coup de pioche pour
  être cassé.

\subsection{Le minerai}

  Du coup, en plus du granit (standard), on a identifié 6 types de minerai.  Le
  marché pouvant être particulièrement volatile, leur valeur en pièces d'or
  varie, de même que le nombre de coups de pioche nécessaires pour les extraire.
...
\subsection{Divers}
  ...
  Normalement dans le manuel d'exploit' ils vous expliqueront tout ça.

  Ah, et une dernière chose. On a trouvé de l'obsidienne. Vous prenez pas la
  tête avec, les nains n'arriveront pas à la miner\footnote{et non pas à
  laminer}.
