...
\subsection{Le minerai}
  ...
  \begin{center}
    \begin{tabular}{|l|Sc|c|c|}
      ...
      \hline
      Granit & \cincludegraphics[width=0.5cm]{frames/granit.png} & 0 \\
      \hline
      Obsidienne & \cincludegraphics[width=0.5cm]{frames/obsidian.png} & -- \\
      \hline
      Charbon & \cincludegraphics[width=0.5cm]{frames/coal.png} & 1 à 4 \\
      \hline
      Fer & \cincludegraphics[width=0.5cm]{frames/iron.png} & 5 à 9 \\
      \hline
      Or & \cincludegraphics[width=0.5cm]{frames/or.png} & 10 à 14 \\
      \hline
      Diamants & \cincludegraphics[width=0.5cm]{frames/diamonds.png} & 15 à 19
      \\
      \hline
      Émeraudes & \cincludegraphics[width=0.5cm]{frames/emerauld.png} & 20 à
      $\infty$
      \\
      \hline
      Rubis & \cincludegraphics[width=0.5cm]{frames/ruby.png} & $\mathbb{Z}$ \\
      \hline
    \end{tabular}
  \end{center}
...
\subsection{Divers}
  ...
  Encore un point de détail : de l'obsidienne a été trouvée en sous-sol. Il est
